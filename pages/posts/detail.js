  ...
  loadFresnsPageData: async function () {
    ...
    const commentsRes = await fresnsApi.comment.commentList(
      Object.assign(this.data.query, {
        orderDirection: 'asc',
        whitelistKeys: 'cid,url,content,contentLength,isBrief,isMarkdown,isAnonymous,isSticky,digestState,createdTimeAgo,editedTimeAgo,likeCount,dislikeCount,commentCount,moreJson,location,files,isCommentPrivate,author.fsid,author.uid,author.username,author.nickname,author.avatar,author.decorate,author.verifiedStatus,author.nicknameColor,author.roleName,author.roleNameDisplay,author.status,manages,editControls,interaction,replyToPost.pid,replyToPost.author.avatar,replyToPost.author.nickname,replyToPost.author.status,replyToPost.isAnonymous,replyToPost.content,replyToPost.group.gname,subComments.0.author.status,subComments.0.author.fsid,subComments.0.author.nickname,subComments.0.isAnonymous,subComments.0.content,subComments.1.author.status,subComments.1.author.fsid,subComments.1.author.nickname,subComments.1.isAnonymous,subComments.1.content,,subComments.2.author.status,subComments.2.author.fsid,subComments.2.author.nickname,subComments.2.isAnonymous,subComments.2.content,,subComments.3.author.status,subComments.3.author.fsid,subComments.3.author.nickname,subComments.3.isAnonymous,subComments.3.content,,subComments.4.author.status,subComments.4.author.fsid,subComments.4.author.nickname,subComments.4.isAnonymous,subComments.4.content',
        page: this.data.page,
      })
    );
